...
- Отправляет на часы только закрытый payload формата `PIN-MIX-XOR-32`, чтобы слабые часы не падали на тяжелом PBKDF2/HKDF/AES и Android с часами считали один и тот же результат.
